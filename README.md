...
Repository for [Speedup for quantum optimal control from automatic differentiation based on graphics processing units](https://journals.aps.org/pra/abstract/10.1103/PhysRevA.95.042318)

## Contents
- [About](#about)
- [Setup](#setup)
- [Cost Functions](#currently-implemented-cost-functions)
- [Use](#use)
- [Examples](#examples)
- [Questions](#questions)
...
## Questions
If you have any questions, please reach either of the developers of the package: Nelson Leung [nelsonleung@uchicago.edu](mailto:nelsonleugn@uchicago.edu), Mohamed Abdelhafez [abdelhafez@uchicago.edu](mailto:abdelhafez@uchicago.edu) or David Schuster [david.schuster@uchicago.edu](mailto:david.schuster@uchicago.edu)
